...
//                .eq(Wtp::getAppId, wtpVo.getAppId())
                .eq(StringUtils.isNotBlank(wtpVo.getAppId()), Wtp::getAppId, wtpVo.getClusterId())
                .eq(StringUtils.isNotBlank(wtpVo.getClusterId()), Wtp::getClusterId, wtpVo.getClusterId())
